...
import type { LevelUpResult } from '../progression/ProgressionService';
import {
    addXp,
    getRequiredXp,
    interpolate,
...
import { pickRandom, randomInt } from '../../shared/utils/random';
...
export function rollDailyGems(): number {
    return randomInt(DAILY_GEM.min, DAILY_GEM.max);
}
